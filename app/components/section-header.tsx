...
export function SectionHeader() {
  ...
  return (
    <header className="site-header">
      ...
      <div className="header-actions"><a className="text-button" href="/planes-lectores">Soy docente</a><a className="save-button" href="/lista" aria-label={`Lista de deseos, ${savedCount} ${savedCount === 1 ? "libro" : "libros"}`}>♡ <span>{savedCount}</span></a></div>
